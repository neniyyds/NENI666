...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(30, 30, 65),        
			Second = Color3.fromRGB(40, 40, 85),      
			Stroke = Color3.fromRGB(70, 70, 150),     
			Divider = Color3.fromRGB(80, 80, 160),    
			Text = Color3.fromRGB(100, 180, 255), 
